...
const AnimationComponent: React.FC<{
	...
	const content =
		per === 'line' ? (
			<motion.span variants={variants} className="ui-block">
				{segment}
			</motion.span>
		) : per === 'word' ? (
			<motion.span
				aria-hidden="true"
				variants={variants}
				className="ui-inline-block ui-whitespace-pre">
				{segment}
			</motion.span>
		) : (
			<motion.span className="ui-inline-block ui-whitespace-pre">
		...
		<AnimatePresence mode="popLayout">
			{trigger && (
				<MotionTag
					...
					className={cn('ui-whitespace-pre-wrap', className)}
